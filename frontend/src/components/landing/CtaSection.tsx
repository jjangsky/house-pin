  ...
  return (
    ...
    >
      <div className="mx-auto max-w-[640px] px-4">
        <div className="cta-card scroll-hidden overflow-hidden rounded-[16px] bg-white shadow-[0_4px_24px_rgba(0,0,0,0.06)]">
          ...
          {/* CTA content */}
          <div className="px-6 pb-8 pt-2 text-center sm:px-8 sm:pb-10">
